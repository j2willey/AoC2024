...
__p2minimum_cost = None

def day13Part1(filename):
    global __p2minimum_cost
    machines = loaddata(filename)
    p1minimum_cost = 0
    p2minimum_cost = 0
    ...
    __p2minimum_cost = p2minimum_cost
    return p1minimum_cost, "Part 1: minimum cost",

def day13Part2(filename):
    global __p2minimum_cost
    if __p2minimum_cost is None:
        day13Part1(filename)[0]
    return __p2minimum_cost, "Part 2: minimum cost"
